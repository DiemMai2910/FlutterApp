...
class SampleItemViewModel extends ChangeNotifier {
  ...
  void updateItem(String id, String newName, String newAuthor,
    ...
    try {
      ...
      debugPrint("Không tìm thấy sách với ID $id");
    }
  }
}
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                          border: OutlineInputBorder(), hintText: 'Tên sách'),
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: 8, vertical: 10),
    ...
    return ValueListenableBuilder<String?>(
      ...
      builder: (context, name, child) {
        return ListTile(
          ...
          subtitle: Text(
              item.author.value == '' ? 'Không có tác giả' : item.author.value),
...
class SampleItemSearchDelegate extends SearchDelegate<SampleItem> {
  ...
  Widget buildResults(BuildContext context) {
    if (query.isEmpty) {
      return const Center(child: Text("Vui lòng nhập tên sách để tìm kiếm"));
    }
